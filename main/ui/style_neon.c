...
void style_neon_next_page(void) { s_page = (s_page + 1) % s_total_pages; rebuild_page(); }
void style_neon_prev_page(void) { s_page = (s_page - 1 + s_total_pages) % s_total_pages; rebuild_page(); }
